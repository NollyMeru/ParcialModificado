...
public class GUIManual extends JFrame {
    ...
    private JTextField UsuariosA;
    private JTextField ClavesA;
    ...
    private JPanel jPanelMenuRegistros;
    ...
    private void initComponents() {
        ...
        jPanelMenuRegistros = new JPanel();
        btnReg = new JLabel();
    ...
    private void accionRegistros() {
        jLabelTop.setText("Iniciar Sesion");
        //jLabelTopDescription.setText("Bievenido al sistema de gestión de mundiales de fútbol");

        jPanelMain.removeAll();
        JPanel Registros1 = new JPanel();
        JLabel imageReg = new JLabel();

        UsuariosA = new JTextField(50);
        UsuariosA.setPreferredSize(new Dimension(77, 45));

        ClavesA = new JTextField(25);
        ClavesA.setPreferredSize(new Dimension(77, 45));

        InicioSesion = new JButton();
        InicioSesion.setPreferredSize(new Dimension(77, 45));
        InicioSesion.setText("Iniciar Sesion");

        jPanelMain.add(new JLabel("Usuarios"));
        jPanelMain.add(UsuariosA);

        jPanelMain.add(new JLabel("Contraseña"));
        jPanelMain.add(ClavesA);
        ...
        jPanelMain.add(ClavesA);
        jPanelMain.add(Registros1, BorderLayout.CENTER);
        jPanelMain.repaint();
        jPanelMain.revalidate();
        /*private JTextField UsuariosA;
    private JTextField ClavesA;
    private JTextField InicioSesion;
         */
        InicioSesion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                String UsuarioB, ClaveB;
                UsuarioB = UsuariosA.getText();
                ClaveB = ClavesA.getText();
                verify = seleccionDAO.UsersReg(UsuarioB, ClaveB);
            }
        });
    }
     ...
     */
    private void pintarMenuRegistro() {
        btnReg.setIcon(new ImageIcon(getClass().getResource("/resources/icons/dashboard_resultados.png")));
        btnReg.setText("Registro");
        btnReg.setForeground(new java.awt.Color(255, 255, 255));

        JLabel vacioRegistros = new JLabel();
        jPanelMenuRegistros.setBackground(new java.awt.Color(17, 41, 63));
        jPanelMenuRegistros.setPreferredSize((new java.awt.Dimension(220, 35)));
        jPanelMenuRegistros.setLayout(new BorderLayout(15, 0));
        jPanelMenuRegistros.add(vacioRegistros, BorderLayout.WEST);
        jPanelMenuRegistros.add(btnReg, BorderLayout.CENTER);
        jPanelMenu.add(jPanelMenuRegistros);
